...
CURVE_SHOCK_VOL_FEATURES = [
    ...
    "next_dec_annualized_carry_v2",
    "next_dec_annualized_carry_gap_le_3m_v2",
    "next_dec_annualized_carry_gap_le_6m_v2",
    ...
    "next_dec_backwardation_steepness_gap_le_3m_v2",
    "next_dec_backwardation_steepness_gap_le_6m_v2",
    "next_dec_backwardation_steepness_gap_le_9m_v2",
    ...
    "mar_dec_annualized_carry_v2",
    "jun_dec_annualized_carry_v2",
    "sep_dec_annualized_carry_v2",
    "mar_dec_backwardation_steepness",
    "jun_dec_backwardation_steepness",
    "sep_dec_backwardation_steepness",
    "mar_dec_backwardation_steepness_v2",
    "jun_dec_backwardation_steepness_v2",
    "sep_dec_backwardation_steepness_v2",
    "mar_dec_annualized_carry_chg_21d",
    "jun_dec_annualized_carry_chg_21d",
    "sep_dec_annualized_carry_chg_21d",
    "mar_dec_annualized_carry_chg_21d_v2",
    "jun_dec_annualized_carry_chg_21d_v2",
    "sep_dec_annualized_carry_chg_21d_v2",
    "mar_dec_backwardation_steepness_chg_21d",
    "jun_dec_backwardation_steepness_chg_21d",
    "sep_dec_backwardation_steepness_chg_21d",
    "mar_dec_backwardation_steepness_chg_21d_v2",
    "jun_dec_backwardation_steepness_chg_21d_v2",
    "sep_dec_backwardation_steepness_chg_21d_v2",
    ...
    "next_dec_annualized_carry_chg_21d_v2",
    "next_dec_annualized_carry_chg_21d_gap_le_3m_v2",
    "next_dec_annualized_carry_chg_21d_gap_le_6m_v2",
    "next_dec_annualized_carry_chg_21d_gap_le_9m_v2",
    ...
    "next_dec_backwardation_steepness_chg_21d_v2",
    "next_dec_backwardation_steepness_chg_21d_gap_le_3m_v2",
    "next_dec_backwardation_steepness_chg_21d_gap_le_6m_v2",
    "next_dec_backwardation_steepness_chg_21d_gap_le_9m_v2",
...
METALS_COMPLEX_DISCOVERY_FEATURES = [
    ...
    "gc_hg_relative_log_accel_11d_vs_63d",
    "gc_hg_relative_log_accel_11d_vs_42d",
